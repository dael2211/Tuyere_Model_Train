...
def main(model_path, dataset_dir):
    ...
    with torch.no_grad():
        for image_file in image_files:
            ...
            # Preprocess the image: resize, normalize, and transpose
            ...
            # Add batch dimension and convert to numpy array of type float32
            images_np = np.expand_dims(image_transposed, axis=0).astype(np.float32)
